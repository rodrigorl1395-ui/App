...
const ICON_PATHS = {
  ...
  chevron: "M9.3 4.6 7.8 6.1l5.9 5.9-5.9 5.9 1.5 1.5 7.4-7.4z",
  ...
  // Despertador: sino clássico, com o badalo em baixo.
  bell: "M12 2a1.3 1.3 0 0 1 1.3 1.3v.86A6.2 6.2 0 0 1 18.3 10v4.2l1.7 2.9a1 1 0 0 1-.86 1.5H4.86a1 1 0 0 1-.86-1.5l1.7-2.9V10a6.2 6.2 0 0 1 5-6.08V3.3A1.3 1.3 0 0 1 12 2Zm0 18.6a2.3 2.3 0 0 0 2.24-1.8H9.76A2.3 2.3 0 0 0 12 20.6Z",
  // Foco Total: cadeado, pro "bloqueio de tela" do modo foco.
  lock: "M8.3 10.2V7.4a3.7 3.7 0 1 1 7.4 0v2.8h.6A2 2 0 0 1 18.3 12.2v6.5a2 2 0 0 1-2 2H7.7a2 2 0 0 1-2-2v-6.5a2 2 0 0 1 2-2Zm2-2.8v2.8h3.4V7.4a1.7 1.7 0 1 0-3.4 0ZM12 14a1.5 1.5 0 0 0-.7 2.83V18.4h1.4v-1.57A1.5 1.5 0 0 0 12 14Z",
  // Agenda: folhinha com espiral no topo e uma grade de dias.
  calendar: "M7 2.4a1 1 0 0 1 1 1V4.6h8V3.4a1 1 0 1 1 2 0V4.6h1.4a2 2 0 0 1 2 2v13a2 2 0 0 1-2 2H4.6a2 2 0 0 1-2-2v-13a2 2 0 0 1 2-2H6V3.4a1 1 0 0 1 1-1ZM4.6 10.2v9.4h14.8v-9.4H4.6Zm2.2 2.2h3v3h-3zm4 0h3v3h-3zm4 0h3v3h-3z",
  // Metas: alvo em três anéis concêntricos.
  target: "M22 12A10 10 0 1 1 2 12A10 10 0 1 1 22 12Z M17 12A5 5 0 1 0 7 12A5 5 0 1 0 17 12Z M14.2 12A2.2 2.2 0 1 1 9.8 12A2.2 2.2 0 1 1 14.2 12Z",
  // Larva: a praga que ataca a árvore de quem sumiu. Corpo em segmentos.
  bug: "M12 4.6c1.9 0 3.5 1.1 4.3 2.7H7.7C8.5 5.7 10.1 4.6 12 4.6Zm-5 4.7h10a5 5 0 0 1 .3 1.7v.9H6.7v-.9a5 5 0 0 1 .3-1.7Zm-.3 4.6h10.6v1.2a5.3 5.3 0 0 1-5.3 5.3 5.3 5.3 0 0 1-5.3-5.3v-1.2Z M3.4 8.1l2.6 1.2-.8 1.7-2.6-1.2z M20.6 8.1l-2.6 1.2.8 1.7 2.6-1.2z M3.6 15.4l2.5-.6.4 1.8-2.5.6z M20.4 15.4l-2.5-.6-.4 1.8 2.5.6z M9.4 2.3l1.3 2.4-1.6.9-1.3-2.4z M14.6 2.3l-1.3 2.4 1.6.9 1.3-2.4z",
  // Cofrinho: porquinho de perfil, com a fenda da moeda no lombo.
  piggybank: "M4.2 13.4a6 6 0 0 1 6-5.9h.5A3 3 0 0 1 13.3 6c1 0 1.9.5 2.4 1.3l2.3-.35-.55 2A6 6 0 0 1 20 13.4v.5l1.5.7-1.5.75v.35a2 2 0 0 1-2 2h-.2l-.65 2.4h-2l-.35-1.9H9.7l-.35 1.9h-2l-.55-2.15a6 6 0 0 1-2.6-4.5Zm3.5 3.3a1.35 1.35 0 1 0 0-2.7 1.35 1.35 0 0 0 0 2.7ZM11.6 9.2h3v1.5h-3Z",
};
